...
//		itemSelector.add("div#content_left>ul>li[id]");
						...
						while (regexPaserUtil.hasNext()) {
							...
							if (first_item_block_html != null) {
								...
								while (itemRegexPaserUtil.hasNext()) {
									...
									// if (temp_key != null
									// && (!StaticValue4WordExt.noneSenseWordSet
									// .contains(temp_key))) {
	...
	public static void main(String[] args) throws Exception {
		...
		// String root_url = "https://www.baidu.com/";
		String root_url = "http://news.baidu.com/";

		// String keyword = "101.244.116.127";
		String keyword = "成功";
		taskPojo.setCrawlEngine(CrawlEngineEnum.MetaSearch_NEWSPage);
		taskPojo.setValue(keyword);
		// List<String> urlArray = IOUtil.getLineArrayFromFile(
		// SystemParas.phantomjs_seeds_path, StaticValue.default_encoding);
		// for (String url : urlArray) {
		// crawlBodyByRandomUrl(url, null);
		//
		// Thread
		// .sleep(SystemParas.node_client_grab_success_sleep_interval_time);
		// }
		// ProxyManager proxyManager = new ProxyManager();
		// ProxyPojo proxyPojo = proxyManager.getOneProxy();
		// System.out.println("proxyPojo---" + proxyPojo);
		// 抓取标红分词
		// Set<String> set = getSplitResult("https://www.baidu.com", keyword,
		// null);
		// 抓取任意page的首页或截图
		// crawlBodyByRandomUrl(root_url, null);
		// Set<String> allLinkUrl = getAllSearchLink(root_url, keyword,
		// proxyPojo);

		List<CrawlData4PortalSite> searchResultList = getAllNewsSearchResult(
				taskPojo, root_url, true);

		// 抓取某个关键搜索结果后的网页正文,仅限于首页
		// String query="123";
		// crawlBodyByUrlSet(root_url, query, proxyPojo);
		// System.out.println(allLinkUrl);
