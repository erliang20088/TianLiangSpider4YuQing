...
public class CpDetectorUtil {
	...
	public String getURLEncoding(String url) {
		java.nio.charset.Charset charset = null;
		try {
	...
	public String getURLEncoding(InputStream is, int length) {
		java.nio.charset.Charset charset = null;
		try {
	...
	public static void main(String[] args) throws Exception {
		CpDetectorUtil testCp = new CpDetectorUtil();
//		 http://www.oscca.gov.cn/
		// http://zzg810314.iteye.com/blog/565542
		String charset = testCp.getURLEncoding("http://www.oscca.gov.cn/");
		// byte[] byteArray = "成功".getBytes("gbk");
		// InputStream bis = new ByteArrayInputStream(byteArray);
		// String charset = testCp.getURLEncoding(bis, byteArray.length);
